...
public class CnfSolver_LimBoole_Tests extends SolverTests {
	...
	{
		return new DefaultCpogSolver<BooleanFormula<FreeVariable>>(new CnfGeneratingOptimiser<FreeVariable>(BooleanOperations.worker, FreeVariable.constructor, FreeVariable.labelGetter), new LimBooleCnfGenerator<FreeVariable>());
	}
}
