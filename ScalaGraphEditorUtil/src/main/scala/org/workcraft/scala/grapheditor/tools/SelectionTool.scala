...
class GenericSelectionTool[N] (
  ...
  paint: (Colorisation, Expression[Set[N]]) => Expression[GraphicalContent],
  ...
  def userSpaceContent = 
    ( paint (GenericSelectionTool.highlightedColorisation, mouseListener_.effectiveSelection) |@| 
