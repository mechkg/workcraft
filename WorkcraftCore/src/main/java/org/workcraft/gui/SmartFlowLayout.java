...
public class SmartFlowLayout implements LayoutManager, java.io.Serializable {
	...
	{
		Func<Component, Dimension> maximumExtremeProvider = new Func<Component, Dimension>() {
			private static final long serialVersionUID = 1L;

			@Override
			public Dimension eval(Component c) {
	...
	{
		Func<Component, Dimension> minimumExtremeProvider = new Func<Component, Dimension>() {
			@Override
			public Dimension eval(Component c) {
	...
	private boolean resize(Container target, int start, int end, int width, Func<Component, Dimension> extremeProvider) 
	{
		int totalFreedom = 0;
		int extremeWidth = 0;
		...
		for(int i=start;i<end;i++)
		{
			...
			{
				Dimension extreme = extremeProvider.eval(component);
