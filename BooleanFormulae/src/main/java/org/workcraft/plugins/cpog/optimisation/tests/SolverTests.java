...
public abstract class SolverTests 
{
	...
	{
		CpogEncoding<FreeVariable> solution = createSolver().solve(smallscenarios,1,0);
		assertNull(solution);
	}
	...
	{
		CpogEncoding<FreeVariable> solution = createSolver().solve(smallscenarios,2,0);
		assertNull(solution);
	}
	...
	{
		CpogEncoding<FreeVariable> solution = createSolver().solve(smallscenarios,2,1);
	...
	{
		CpogEncoding<FreeVariable> solution = createSolver().solve(smallscenarios,2,2);
		assertNotNull(solution);
	}
	...
	{
		CpogEncoding<FreeVariable> solution = createSolver().solve(smallscenarios,2,3);
		assertNotNull(solution);
	}
	...
	{
		CpogEncoding<FreeVariable> solution = createSolver().solve(smallscenarios,3,0);
		assertNotNull(solution);
	}
