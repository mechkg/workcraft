...
public class CnfSolverTests extends SolverTests {
	...
	{
		return new DefaultCpogSolver<Cnf<FreeVariable>>(new CnfGeneratingOptimiser<FreeVariable>(BooleanOperations.worker, FreeVariable.constructor, FreeVariable.labelGetter), new SimpleCnfTaskProvider<FreeVariable>(FreeVariable.labelGetter));
	}
}
