...
public interface ColorisableGraphicalContent {
	...
	public class Util {
		...
		public static Function2<ColorisableGraphicalContent, Colorisation, GraphicalContent> applyColourisation = new Function2<ColorisableGraphicalContent, Colorisation, GraphicalContent>() {
			@Override
