...
public class OneHotSolverTests extends SolverTests {
	...
	{
		return new DefaultCpogSolver<BooleanFormula<FreeVariable>>(new Optimiser<FreeVariable, OneHotIntBooleanFormula<FreeVariable>>(FreeVariable.constructor, new OneHotNumberProvider<FreeVariable>(FreeVariable.constructor)), new LimBooleCnfGenerator<FreeVariable>());
	}
}
