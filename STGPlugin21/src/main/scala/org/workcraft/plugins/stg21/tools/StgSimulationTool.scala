...
import org.workcraft.gui.modeleditor.tools.EmptyModelEditorTool2Activation
...
object Sim {
  ...
  def createSimulationTool(visualStg: VisualStg): IO[ToolEnvironment => ModelEditorTool2Activation] = IO.ioPure.pure {
    ...
    env => toolStub(env) |+| new EmptyModelEditorTool2Activation{
