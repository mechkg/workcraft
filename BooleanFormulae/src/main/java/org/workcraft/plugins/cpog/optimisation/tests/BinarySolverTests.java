...
public class BinarySolverTests extends SolverTests {
	...
	{
		return new DefaultCpogSolver<BooleanFormula<FreeVariable>>(new Optimiser<FreeVariable, BinaryIntBooleanFormula<FreeVariable>>(FreeVariable.constructor, new BinaryNumberProvider()), new LimBooleCnfGenerator<FreeVariable>());
	}
}
