...
public class DotGSerialiser {
	...
	private static void writeGraphEntry(PrintWriter out, Model model, Node node) {
	...
	private static void go(Action1<PrintWriter> serialiser, OutputStream outStream) {
	...
	public void serialise(final PetriNetModel model, OutputStream outStream) {
		go(new Action1<PrintWriter>(){
			@Override
			public void run(PrintWriter out) { writePN(model, out); }
		}, outStream);		
	}

	public static void serialise(final STGModel model, OutputStream outStream) {
		go(new Action1<PrintWriter>(){
			@Override
			public void run(PrintWriter out) { writeSTG(model, out); }
		}, outStream);
	}

	private static void writeSTG(STGModel stg, PrintWriter out) {
	...
	private static void writeMarking(Model model, Collection<? extends Place> places, PrintWriter out) {
